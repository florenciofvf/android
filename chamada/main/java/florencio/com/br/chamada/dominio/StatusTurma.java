...
public class StatusTurma extends Entidade {
    ...
    public StatusTurma(Long _id, String nome, String descricao) {
        this._id = _id;
        this.nome = nome;
    ...
    public Entidade criar(Cursor cursor) {
        return new StatusTurma(cursor.getLong(ID_IDX), cursor.getString(NOME_IDX), cursor.getString(DESCRICAO_IDX));
    }
