...
public class InstrutorListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private InstrutorAdaptador adaptador;
    private List<Instrutor> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<Instrutor>) fragmentoOuvinte.getChamadaServico().listar(new Instrutor());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new InstrutorAdaptador(objetos, getActivity(), modoExclusao);
