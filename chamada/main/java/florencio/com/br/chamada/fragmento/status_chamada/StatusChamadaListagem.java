...
public class StatusChamadaListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private StatusChamadaAdaptador adaptador;
    private List<StatusChamada> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<StatusChamada>) fragmentoOuvinte.getChamadaServico().listar(new StatusChamada());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new StatusChamadaAdaptador(objetos, getActivity(), modoExclusao);
    ...
    public List<? extends Entidade> getSelecionados() {
        List<StatusChamada> lista = new ArrayList<>();
        for(StatusChamada c : objetos) {
            if(c.isSelecionado()) {
                lista.add(c);
            }
        }
