...
public class TurnoListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private TurnoAdaptador adaptador;
    private List<Turno> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<Turno>) fragmentoOuvinte.getChamadaServico().listar(new Turno());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new TurnoAdaptador(objetos, getActivity(), modoExclusao);
