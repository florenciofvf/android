...
public class LaboratorioListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private LaboratorioAdaptador adaptador;
    private List<Laboratorio> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<Laboratorio>) fragmentoOuvinte.getChamadaServico().listar(new Laboratorio());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new LaboratorioAdaptador(objetos, getActivity(), modoExclusao);
