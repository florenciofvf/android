...
public class FrequenciaListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private FrequenciaAdaptador adaptador;
    private List<Frequencia> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<Frequencia>) fragmentoOuvinte.getChamadaServico().listar(new Frequencia());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new FrequenciaAdaptador(objetos, getActivity(), modoExclusao);
