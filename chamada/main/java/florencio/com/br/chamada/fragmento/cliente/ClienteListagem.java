...
public class ClienteListagem extends ListFragment implements FragmentoListagem {
    ...
    public void atualizarListagem() {
        objetos = (List<Cliente>) fragmentoOuvinte.getChamadaServico().listar(new Cliente());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new ClienteAdaptador(objetos, getActivity(), modoExclusao);
