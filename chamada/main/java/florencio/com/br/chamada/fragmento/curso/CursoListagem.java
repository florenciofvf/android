...
public class CursoListagem extends ListFragment implements FragmentoListagem {
    private FragmentoOuvinte fragmentoOuvinte;
    private CursoAdaptador adaptador;
    private List<Curso> objetos;
    ...
    public void atualizarListagem() {
        objetos = (List<Curso>) fragmentoOuvinte.getChamadaServico().listar(new Curso());
        setAdaptador(false);
    }

    private void setAdaptador(boolean modoExclusao) {
        adaptador = new CursoAdaptador(objetos, getActivity(), modoExclusao);
