...
public class ExternoPrivadoActivity extends AppCompatActivity {
    private final String NOME_ARQUIVO = "ARQUIVO_EXTERNO_PRIVADO";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.externo_privado_layout);
